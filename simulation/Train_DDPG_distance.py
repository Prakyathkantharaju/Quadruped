...
rel_path = 'models/distance_simple.xml'
path = path_ + '/' + rel_path
# load environment
...
gym.envs.register(
     id='car-robot-distance',
     entry_point='car_env_2:CarEnv',
...
if __name__ == '__main__':
    ...
    model = DDPG("MlpPolicy", train_env, tensorboard_log=f"./.run_logs/logs/{run.id}", device="cuda", learning_rate=1e-5,create_eval_env=True)
